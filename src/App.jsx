...
function ReporteEvolucionImprimible({ paciente }) {
  ...
  return (
    <div id="neuroflex-clinical-report" style={{ background: "#fff", color: "#202632", padding: 28, borderRadius: 16, border: "1px solid #e6e8ef" }}>
      ...
      <section style={{ marginBottom: 22 }}>
        <h3 style={{ fontSize: "1rem", marginBottom: 10 }}>5. Revisión sugerida del plan</h3>
        {(() => {
      ...
      <section style={{ marginBottom: 22 }}>
        <h3 style={{ fontSize: "1rem", marginBottom: 10 }}>6. Sesiones recientes</h3>
  ...
  return (
    <div>
      ...
      <Card className="nf-no-print" style={{ marginBottom: 16 }}>
        ...
        <BtnPrimary onClick={printReport} disabled={type === "session" && !selectedSession}>
